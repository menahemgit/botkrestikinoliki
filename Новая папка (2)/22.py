...
async def setup_commands(application: Application) -> None:
    ...
    commands = [
        BotCommand("start", "Начать игру или вернуться в главное меню"),
        BotCommand("newgame", "Создать новую мультиплеерную игру"),
        BotCommand("botgame", "Создать новую игру с ботом"),
        BotCommand("join", "Присоединиться к игре по коду"),
        BotCommand("stats", "Показать вашу статистику"),
        BotCommand("leaderboard", "Показать таблицу лидеров"),
        BotCommand("rules", "Показать правила игры"),
